...
const generateSmartReply = async (incomingText, tone, customPrompt, customerName) => {
  try {
    const baseSystemInstruction = customPrompt || "You are an advanced AI support engine. Understand context, slang, and typos. Provide empathetic and accurate resolutions.";
    ...
    const contextInstruction = `${baseSystemInstruction}\nCustomer Name: ${customerName}.\nTone Profile: ${tone}.\n` +
      ...
      `Always personalize the greeting using the customer's name.`;
